  ...
  window.ChatWidgetConfig = {
      ...
      branding: {
          ...
          welcomeText: 'Welcome to  Aegis Living. I am your Community Care Advisor and I am here to help guide you towards the answers you are needing. May I start by having you first so I know how to address you?', //Welcome message
  ...
  @media screen and (max-width: 600px) {
    ...
    async function sendMessage(message) {
      ...
      // Community data mapping (stores both Community ID and Location Name)
      const communityMap = {
          "/locations/aegis-living-las-vegas-nv": { id: "lasvblue", name: "Las Vegas" },
          "/locations/aegis-living-san-francisco-ca": { id: "snfrblue", name: "San Fran" },
          "/locations/aegis-living-aptos-ca": { id: "aptoblue", name: "Aptos" },
          "/locations/aegis-living-corte-madera-ca": { id: "cortblue", name: "Corte Madera" },
          "/locations/aegis-living-shadowridge-oceanside-ca": { id: "shad001", name: "Shadowridge" },
          "/locations/aegis-living-west-seattle-wa": { id: "wsea001", name: "West Seattle" },
          "/locations/aegis-gardens-newcastle-wa": { id: "agnew001", name: "Aegis Gardens Newcastle" },
          "/locations/aegis-living-carmichael-ca": { id: "carm001", name: "Carmichael" },
          "/locations/aegis-living-fremont-ca": { id: "frem001", name: "Fremont" },
          "/locations/aegis-living-kirkland-waterfront-wa": { id: "klake001", name: "Kirkland Waterfront" },
          "/locations/aegis-living-greenwood-seattle-wa": { id: "green001", name: "Greenwood" },
          "/locations/aegis-living-issaquah-wa": { id: "issa001", name: "Issaquah" },
          "/locations/aegis-living-madison-seattle-wa": { id: "madi001", name: "Madison" },
          "/locations/aegis-living-laguna-niguel-ca": { id: "lagu001", name: "Laguna" },
          "/locations/aegis-living-queen-anne-galer-seattle-wa": { id: "gale001", name: "Galer" },
          "/locations/aegis-gardens-fremont-ca": { id: "agarblue", name: "Aegis Gardens Fremont" },
          "/locations/aegis-living-moraga-ca": { id: "mora001", name: "Moraga" },
          "/locations/aegis-living-bellevue-overlake-wa": { id: "ovlk001", name: "Bellevue Overlake" },
          "/locations/aegis-living-ravenna-seattle-wa": { id: "raven001", name: "Ravenna" },
          "/locations/aegis-living-laurelhurst-seattle-wa": { id: "laur001", name: "Laurelhurst" },
          "/locations/aegis-living-redmond-wa": { id: "redm001", name: "Redmond" },
          "/locations/aegis-lodge-kirkland-wa": { id: "lodgblue", name: "Aegis Lodge" },
          "/locations/aegis-living-ballard-seattle-wa": { id: "blrd001", name: "Ballard" },
          "/locations/aegis-living-bellevue-wa": { id: "bellblue", name: "Bellevue" },
          "/locations/aegis-living-granada-hills-ca": { id: "granblue", name: "Granada" },
          "/locations/aegis-living-queen-anne-rodgers-park-seattle-wa": { id: "rodgr001", name: "Rodgers Park" },
          "/locations/aegis-living-dana-point-ca": { id: "danablue", name: "Dana Point" },
          "/locations/aegis-living-lake-union-seattle-wa": { id: "lakeu001", name: "Lake Union" },
          "/locations/aegis-living-lynnwood-wa": { id: "lynn001", name: "Lynnwood" },
          "/locations/aegis-living-pleasant-hill-ca": { id: "pleablue", name: "Pleasant Hill" },
          "/locations/aegis-living-kent-wa": { id: "kent001", name: "Kent" },
          "/locations/aegis-living-shoreline-wa": { id: "shorblue", name: "Shoreline" },
          "/locations/aegis-living-marymoor-redmond-wa": { id: "mary001", name: "Marymoor" },
          "/locations/aegis-living-ventura-ca": { id: "ventblue", name: "Ventura" },
          "/locations/aegis-lodge-kirkland-wa": { id: "kirkblue", name: "Aegis Lodge" },
          "/locations/aegis-living-callahan-house-shoreline-wa": { id: "callblue", name: "Callahan" },
          "/locations/aegis-living-mercer-island-wa": { id: "mercr001", name: "Mercer" },
          "/locations/aegis-living-napa-ca": { id: "napa001", name: "Napa" },
          "/locations/aegis-living-san-rafael-ca": { id: "snfl001", name: "San Rafael" }
      };
  
      // Function to get the Community ID and Location Name
      function getCommunityInfo() {
          const currentUrl = window.location.href.toLowerCase(); // Normalize case
          for (const path in communityMap) {
              if (currentUrl.includes(path.toLowerCase())) {
                  return communityMap[path];
              }
          }
          return { id: "nocomm", name: "Unknown Location" }; // Default if no match found
      }
  
      const communityInfo = getCommunityInfo(); // Retrieve community info
      ...
      const messageData = {
          ...
          metadata: { 
              ...
              locationName: communityInfo.name,
              userIP: userIP
          }
      };
    ...
    if (isDesktop) {
      setTimeout(function() {
        // Only auto-open if the chat isn't already open
        if (!chatContainer.classList.contains('open')) {
